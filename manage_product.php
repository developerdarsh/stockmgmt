...
<html lang="en">
											...
											<div class="col-md-12 ">
												<form action="#" onSubmit="return searchByName();">
													<div class="row">
														...
														<div class="col-md-3">
															<button type="submit" class="btn btn-gradient-primary"><i class="mdi mdi-magnify"></i></button>
															<button type="submit" class="btn btn-gradient-danger" title="Clear Search Result" value="clear" onClick="clearSearchByName();"><i class="mdi mdi-filter-remove"></i></button>
														</div>
													</div>
												</form>
											</div>
										...
										<div class="box-body no-padding">
											<div class="col-md-12 table-responsive">
												<div class="loading-div" style="display:none;">
													<div><img style="width:10%;margin-left:440px;" src="<?php echo SITEURL; ?>assets/images/loader.svg"></div>
												</div>
												<div id="results"></div>
											</div>
										</div>
	...
	/*Table 1 */
		...
		function displayRecords(numRecords) {
			...
			var data_url    = "<?php echo SITEURL; ?>ajax_get_<?php echo $page; ?>.php?show=" + numRecords + "&searchName=" + searchName;
			$("#results").html("");
			$(".loading-div").show();
		...
		function del_conf(id){
			...
			if(r){
				window.location.href='<?php echo SITEURL; ?>add-<?php echo $page; ?>/delete/'+id+'/';
			}
		}
	</script>
</html>