...
(function (window, $, undefined) {
    ...
    $.html5imageupload = function html5imageupload(options, element) {
        ...
        //buttons
        this.button = {}
        // this.button.edit = '<div class="btn-sm btn-info btn-edit"><i class="mdi mdi-pencil-box"></i></div>'
        // this.button.saving = '<div class="btn btn-sm btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="mdi mdi-content-save"></i></div>';
        // this.button.zoomin = '<div class="btn btn-sm btn-primary btn-zoom-in"><i class="mdi mdi-fullscreen"></i></div>';
        // this.button.zoomout = '<div class="btn btn-sm btn-info btn-zoom-out"><i class="mdi mdi-fullscreen-exit"></i></div>';
        // this.button.zoomreset = '<div class="btn btn-sm btn-warning btn-zoom-reset"><i class="mdi mdi-file-restore"></i></div>';
        // this.button.cancel = '<div class="btn btn-sm btn-danger btn-cancel"><i class="mdi mdi-delete"></i></div>';
        // this.button.done = '<div class="btn btn-sm btn-success btn-ok"><i class="mdi mdi-check-circle"></i></div>';
        // this.button.del = '<div class="btn btn-sm btn-danger btn-del"><i class="mdi mdi-delete"></i></div>';


this.button.edit = '<div class="btn btn-gradient-info btn-edit" style="width:17px; height:17px; background-color: #d2d2d2 !important; text-align:center; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-pencil-box"></i></div>'
        this.button.saving = '<div class="btn btn-gradient-warning saving" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;">' + (this.options.saveLabel || 'Saving...') + ' <i class="mdi mdi-content-save"></i></div>';
        this.button.zoomin = '<div class="btn btn-gradient-primary btn-zoom-in" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-fullscreen"></i></div>';
        this.button.zoomout = '<div class="btn btn-gradient-info btn-zoom-out" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-fullscreen-exit"></i></div>';
        this.button.zoomreset = '<div class="btn btn-gradient-warning btn-zoom-reset" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-file-restore"></i></div>';
        this.button.cancel = '<div class="btn btn-gradient-danger btn-cancel" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-delete"></i></div>';
        this.button.done = '<div class="btn btn-gradient-success btn-ok" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-check-circle"></i></div>';
        this.button.del = '<div class="btn btn-gradient-danger btn-del" style="width:17px; height:17px; background-color: #d2d2d2 !important; display:flex; align-items:center; justify-content:center;"><i class="mdi mdi-delete text-danger"></i></div>';
