<?php
	...
	if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
		$ctable_where .= " (
			...
			stock >= ".(int) $_REQUEST['searchName']." OR
			price >= ".(float) $_REQUEST['searchName']."
		) AND ";
	}
			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td><?php echo $ctable_d['stock']; ?></td>
						<td><?php echo CURR . $db->rpnum($ctable_d['price']); ?></td>
						<td>
	                		<a href="<?php echo SITEURL; ?>add-<?php echo $page; ?>/edit/<?php echo $ctable_d['id']; ?>/" title="Edit" class="btn-gradient-info p-1"><i class="mdi mdi-lead-pencil"></i></a>
